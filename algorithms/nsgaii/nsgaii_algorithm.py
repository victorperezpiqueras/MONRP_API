...
from algorithms.models.individual import Individual
...
class NSGAIIAlgorithm:
    def __init__(self, problem, random_seed=None, population_length=20, max_generations=1000,
        ...
        self.utils = NSGAIIUtils(
            self.problem, random_seed, selection_candidates, crossover_prob, mutation_prob)
    ...
    def generate_starting_population(self):
        ...
        for i in range(0, self.population_length):
            individual = Individual(
                self.problem.genes, self.problem.objectives)
